    ...
    return {
            ...
            return $.Deferred(function (dfd) {
                SMART.get_problems().then(function (r) {
                    ...
                    _(r.objects.of_type.Problem).each(function (p) {
                        var problem = { "CID": p.problemName.code.dcterms__identifier, "problemName": p.problemName.dcterms__title };
                        var title = problem.problemName;
        ...
        getFromJSON: function () {
            this.patient = {
                ...
                "problems":[
                    { "CID": "1201005", "problemName": "Benign essential hypertension", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "29857009", "problemName": "Chest pain", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "429673002", "problemName": "Coronary arteriosclerosis", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "59621000", "problemName": "Essential hypertension", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "4557003", "problemName": "Preinfarction syndrome", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "195967001", "problemName": "Asthma", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "44054006", "problemName": "Diabetes mellitus type 2", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "55822004", "problemName": "Hyperlipidemia", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "43339004", "problemName": "Hypokalemia", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "185903001", "problemName": "Needs influenza immunization", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "267432004", "problemName": "Pure hypercholesterolemia", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "73430006", "problemName": "Unspecified sleep apnea", "category": "Normal", startDate: '1/1/2000' },
                    { "CID": "4557003", "problemName": "Preinfarction syndrome", "category": "Normal", startDate: '1/1/2000' },
                ],
                "allergies":[
